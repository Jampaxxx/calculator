...
class _SimpleCalculatorState extends State<SimpleCalculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Reggae Calculator')),
      body: Column(
        children: <Widget>[
          Container(
              ...
              Container(
                ...
                child: Table(
                  children: [
                    TableRow(
                        children: [
                          buildButton("C", 1, Colors.green.shade900 ),
                          buildButton("x", 1, Colors.yellow.shade800 ),
                          buildButton("/", 1, Colors.red.shade800 ),
              ...
              Container(
                ...
                child: Table(
                  children: [
                    ...
                    TableRow(
                        children: [
                          buildButton("-",1,Colors.green.shade900),
                        ]
                    ),
                    TableRow(
                        children: [
                          buildButton("+",1,Colors.yellow.shade800),
                        ]
                    ),
                    TableRow(
                        children: [
